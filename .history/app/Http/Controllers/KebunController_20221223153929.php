...
class KebunController extends Controller
{
    ...
    {
        //
        return Inertia::render('Kebun/Index', ['kebun' => Kebun::with('user:id,name')->latest()->get(),]);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request, Kebun $kebun)
    {
        //
        ...
        $request->user()->kebun()->create($validated);
