...
import MFB from "@/Components/Create";
//import AuthenticatedLayout from "@/Layouts/AuthenticatedLayout";
import Side from "@/Layouts/Sidebar";
import InputError from "@/Components/InputError";
import PrimaryButton from "@/Components/PrimaryButton";
import { useForm, Head, usePage } from "@inertiajs/inertia-react";
import { Label, TextInput, Textarea, Table, Button } from "flowbite-react";

export default function Index(props) {
    const { auth } = usePage().props;
    const { data, setData, post, processing, reset, errors } = useForm({
        nama: props.kebun.nama,
        alamat: props.kebun.nama,
    });

    const submit = (e) => {
        e.preventDefault();
        post(route("kebun.update", kebun.id), { onSuccess: () => reset() });
    };
